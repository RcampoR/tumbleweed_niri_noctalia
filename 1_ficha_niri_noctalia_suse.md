...
| Campo | Valor |
|-------|-------|
| Versión del documento | 1.0 (Proyecto consolidado) |
...
7. Script de exportación de la paleta Noctalia hacia Kitty y otras aplicaciones para mantener un único origen de colores.
