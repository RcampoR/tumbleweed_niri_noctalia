...
### Aviso de GNOME Keyring al iniciar VSCodium
- **Estado:** pendiente de resolver definitivamente.
...
**Sistema**
- Resolver aviso de GNOME Keyring en VSCodium.
- Documentar flujo completo de arranque: greetd → UWSM → Niri → Noctalia.
- Eliminar repositorio de pruebas de Graphite (descartado).
