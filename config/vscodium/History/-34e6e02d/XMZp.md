...
## Estado actual del sistema (2026-07)

### Portapapeles

Actualmente el sistema utiliza el gestor de portapapeles integrado de Noctalia.

Evidencias:

- Existe el widget `clipboard`.
- Existe el comando:

  noctalia msg clipboard-clear

- El historial aparece correctamente desde el icono de la barra.
- No se utiliza cliphist.
- No existen fuzzel, rofi, wofi, walker ni tofi instalados.
- El atajo añadido manualmente mediante:

    cliphist list | fuzzel ...

fue un experimento y no forma parte de la configuración definitiva.

### Pendiente

Encontrar el identificador interno del panel Clipboard de Noctalia para poder abrirlo mediante teclado.

Actualmente no funcionan:

- noctalia msg clipboard
- noctalia msg clipboard-toggle
- noctalia msg panel clipboard

Es probable que el panel utilice un ID interno aún no documentado.

Cuando se descubra dicho ID:

- eliminar el bloque Clipboard History agregado en niri;
- sustituirlo por una llamada oficial de Noctalia;
- mantener un único gestor de portapapeles (el nativo de Noctalia).
