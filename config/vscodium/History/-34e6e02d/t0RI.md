...
| Campo | Valor |
|-------|-------|
| Versión del documento | 1.1 (Transparencias y aplicaciones consolidadas) |
...
```text
~/.config/niri/config.kdl                              # Configuración del compositor y reglas
~/.config/noctalia/                                    # Shell, paletas y módulos
~/.config/kitty/kitty.conf                             # Terminal (colores alineados)
~/.config/gtk-3.0/gtk.css                              # Anulación de fondos opacos en Thunar/GTK3
~/.config/VSCodium/User/settings.json                  # Tematización interna de Codium
~/.var/app/app.zen_browser.zen/.zen/<profile>/chrome/  # userChrome.css para Zen Browser
~/.bashrc                                              # Alias y entorno CLI
